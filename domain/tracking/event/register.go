...
import (
	...
	"ns-tracking-go/domain/tracking/event/listener"

	"github.com/zeromicro/go-zero/core/logx"
)

// RegisterListeners 统一注册监听�?
// 作用：启动时调用，将所有监听器注册�?Dispatcher
...
func RegisterListeners(d dispatcher.Dispatcher) {
	...
	// 📌 下期预留�?
	// d.Register("tracking.upserted", listener.NewKafkaListener())  // 投�?Kafka
	...
	// d.Register("tracking.upsert_failed", listener.NewRetryListener())  // 业务级补偿重�?
