...
replace ns-tracking-go/domain/tracking => ../domain/tracking

replace ns-tracking-go/infrastructure => ../infrastructure

replace ns-tracking-go/pkg => ../pkg
